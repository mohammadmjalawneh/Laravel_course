...
<head>
    ...
    <link rel="icon" href="{{url('img/favicon.png')}}" type="image/png" sizes="16x16">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://127.0.0.1:8000/ourteam">Our Team</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="jumbotron">
                <h1 class="display-4">Jameel's welcome for every One</h1>
                <p class="lead">
